...
export function providerBadgeClass(provider?: string | null): string {
  ...
  switch (p) {
    ...
    case 'itunes':
      return 'border-pink-300 bg-pink-50 text-pink-900 dark:border-pink-700 dark:bg-pink-950 dark:text-pink-200';
    case 'deezer':
      return 'border-fuchsia-300 bg-fuchsia-50 text-fuchsia-900 dark:border-fuchsia-700 dark:bg-fuchsia-950 dark:text-fuchsia-200';
    case 'spotify':
      return 'border-emerald-300 bg-emerald-50 text-emerald-900 dark:border-emerald-700 dark:bg-emerald-950 dark:text-emerald-200';
    case 'qobuz':
