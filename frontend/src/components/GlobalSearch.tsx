  ...
  return (
    <div ref={rootRef} className={cn('relative w-full', className)}>
      ...
      <Input
        ...
        className="h-10 md:h-11 pl-9 pr-9 rounded-xl border-primary/30 bg-background/85 text-sm shadow-[0_0_0_1px_rgba(249,115,22,0.12)] focus-visible:border-primary/45 focus-visible:ring-1 focus-visible:ring-primary/35 focus-visible:ring-offset-0"
      />
      {loading ? (
