...
const SIDEBAR_COOKIE_NAME = "sidebar:state:v2";
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className="safe-bottom safe-top w-[--sidebar-width] max-w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
